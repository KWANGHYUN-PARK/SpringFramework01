...
<body>
   ...
   <div class="container">
      ...
      <!--     rno값을 입력하면 해당 rno가 있는지 조회하는 ...
     추후 아이디 조회에 응요할 수 있음 -->
      <!-- <div class="row">
      	<input type="number" id="inputID"><button id="inputCheckBtn">rno체크</button>
      	<p id="msgforuse"></p>
      </div>
	 ...
	 <div class="row">
      	<input type="number" id="inputID2"><button id="inputCheckBtn2">rno체크</button>
      	<p id="msgforuse2"></p>
      </div> -->
...
{{/each}}
   ...
   <script type="text/javascript">
      ...
      function printPaging(pm) {
         //자바스크립트는 파라미터넣을때 자료형같이안넣고 변수명만 넣어줘도 됨
          var str = "";
